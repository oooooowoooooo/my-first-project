...
datafile = "C:\\Users\\hp\\Desktop\\K-means\\air_data.csv"
...
filter_data.loc[:,'入会时间'] = filter_data['入会时间'].astype(np.int64)/(60*60*24*10**9)
print("="*30)
print(filter_data[0:5])
...
if __name__=='__main__':	
	...
	nums, SSE = Kmeans_nclusters(filter_zscore_data)
